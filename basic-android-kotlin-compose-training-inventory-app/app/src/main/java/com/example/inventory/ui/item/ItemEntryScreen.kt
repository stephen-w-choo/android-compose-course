...
fun ItemEntryScreen(
    ...
    // remember CoroutineScope() is a composable function that returns a CoroutineScope
    // it will be bound to the lifecycle of this composable
    // will cancel after the scope leaves the composition
    Scaffold(
        topBar = {
            InventoryTopAppBar(
